...
#define BACKL_TOUT 40       // таймаут неактивности отключения дисплея, секунды
...
// ------ Лента ------
#define MAX_CURRENT 5000       // макс. ток в мА, при значении 0 фича не активируется
#define NUM_LEDS 78         // кол-во светодиодов для расчёта ограничения тока (только для диодов 5050!!!)
...
#define CHARGE_VAL 0      // вывод напряжения: 0 - в процентах, 1 - в вольтах
...
#define VREF 4.44            // напряжение на пине 5V
#define R1 9999            // точное значение 10 кОм
#define R2 4590             // точное значение 4.7 кОм
